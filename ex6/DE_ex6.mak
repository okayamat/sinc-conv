...
PACKAGE	= DE_ex6
SRCS	= $(PACKAGE).cpp DE_trans.cpp polevl.cpp fresnl.cpp
HEADS	= DE_trans.h mconf.h
OBJS	= $(SRCS:.cpp=.o)
...
LDFLAGS	= -g $(DEBUG) $(EIG_LD)   -std=c++11
#LDLIBS	= -lm
...
CXXFLAGS= -g $(OPTIMIZE) -Wall $(DEBUG) $(EIG_FL)   -std=c++11
